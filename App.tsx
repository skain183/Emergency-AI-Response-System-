...
function App() {
  ...
  const handleCountdownCancel = () => {
    ...
    // Transition to report view for both Text and Live modes
    if (mode === 'SYMPTOM_TEXT' || mode === 'SYMPTOM_LIVE') {
        ...
        {mode === 'SYMPTOM_LIVE' && (
          <SymptomLiveMode 
            ...
            onReportGenerated={(res) => {
              ...
              // Ensure we check if we need to switch mode. 
              // If Global Dispatch is active, we don't want to override it to REPORT mode yet.
              // BUT, the SymptomLiveMode unmounts anyway.
              // We only switch to REPORT if we are NOT in DISPATCH mode.
              // However, since onReportGenerated is called at end of session, we typically want to show report.
              // If Emergency was triggered, App's dispatchCountdown is active over everything.
              setMode('SYMPTOM_REPORT'); 
            }}
